...
##    )
##
### def redraw_window(lives, level, mainfont, lostfont, lost):
###     WIN.blit(background, (0,0))
##
###     # Draw Lables of Live and level
###     liveslab = mainfont.render(f"Lives: {lives}", 1, (255,255,255))
###     levellab = mainfont.render(f"Level: {level}", 1, (255,255,255))
##
###     WIN.blit(liveslab, (10, 10))
###     WIN.blit(levellab, (Width - levellab.get_width() - 10, 10))
##
###     # Draw Enemies ships into the screen
###     for i in ENEMIES:
###         makeship(WIN, i)
##    
###     # Draw Player ship into the screen
###     makeship(WIN, playermap)
###     draw_healthbar(WIN, playermap)
##
###     # Draw Lasers into the screen
###     for i in plasers:
###         makelaser(WIN, i)
###     for i in elasers:
###         makelaser(WIN, i)
##
###     if lost:
###         lostlab = lostfont.render("You Lost!!", 1, (255,255,255))
##        
###         WIN.blit(lostlab, (Width/2 - lostlab.get_width()/2, 350))
##
...
###     global plasers
###     global elasers
###     global playermap # Access global lists/dictionary
##
###     run = True
###     FPS = 60
###     level = 0
###     lives = 5
###     mainfont = pygame.font.SysFont("Times New Roman", 50)
###     lostfont = pygame.font.SysFont("Times New Roman", 60)
###     wave_length = 5
###     enemy_vel = 1
###     player_vel = 5
###     laser_vel = 5
...
##    enemy_vel = 1
##    player_vel = 5
##    laser_vel = 5 # Used for player (up), enemies use negative laser_vel (down)
##
##    clock = pygame.time.Clock()
##
##    lost = False
...
##
##            # Enemy shooting
##            if random.randrange(0, int((2-0.05*level) * FPS)) == 1: # 2*FPS is roughly a 2-second average cooldown
...
##                
##
##        # --- Laser Movement and Collision (Enemy Lasers vs Player) ---
##        move_lasers(elasers, laser_vel+2*level) # Enemy lasers move down (positive vel)
##        
...
##
##
##        # --- Laser Movement and Collision (Player Lasers vs Enemies) ---
##        move_lasers(plasers, -laser_vel) # Player lasers move up (negative vel)
##
...
###     pygame.quit()
##def main_menu():
##    pygame.display.set_caption("My Pygame App")  # set window title
##
...
##        WIN.blit(background, (0, 0))
##
##        # dark overlay so text/buttons pop
##        overlay = pygame.Surface((Width, Height), pygame.SRCALPHA)
##        overlay.fill((0, 0, 0, 150))  # last value = transparency
